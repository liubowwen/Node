...
<div style="margin: 30px" >
    <div class="col-xs-2 col-sm-2 col-md-2 color modal-body"  id="left" >
       ...
       <div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 font color "  data-id="${node.getId()}"  id="right"  onclick="show1(this)">
  ...
  <div id="view"class="col-xs-12 col-sm-12 col-md-12" >
              ...
              <div id="div2" class="text1 text" name="content"  style=""> <!--可使用 min-height 实现编辑区域自动增加高度-->
